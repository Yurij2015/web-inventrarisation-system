...
INSERT INTO `acceptmaterial` (`idaccept`, `date`, `employee`, `material`, `vendor`, `transporter`, `cost`, `count`, `units`) VALUES
(1, '2020-01-01', 1, 1, 1, 1, 444, 5, 'Тонны');
...
INSERT INTO `employee` (`idemployee`, `name`, `phone`) VALUES
(1, 'Петров Олег', '+7897008881'),
...
INSERT INTO `inventarisation` (`idinventarisation`, `date`, `material`, `count`, `units`, `employee`, `actnumber`, `protocolnumber`) VALUES
(1, '2020-01-03', 1, 7, 'Литры', 2, '2', '2');
...
INSERT INTO `material` (`idmaterial`, `invnumber`, `name`, `description`, `materialcategory`) VALUES
(1, '898989', 'Цемент', 'Цемент 200', 1);
...
INSERT INTO `materialcategory` (`idmaterialcategory`, `categoryname`, `description`) VALUES
(1, 'Категория 1', 'Категория 1');
...
INSERT INTO `materialstorage` (`idfoodstorage`, `racknumber`, `storehouse`, `material`) VALUES
(1, 444, 1, 1);
...
('m000000_000000_base', 1577923377),
...
INSERT INTO `storehouse` (`idstorehouse`, `name`, `adress`, `employee_idemployee`) VALUES
(1, 'storehouse1', 'Ленина, 22', 1),
...
INSERT INTO `transporter` (`idtransporter`, `name`, `adress`, `phone`, `info`) VALUES
(1, 'ООО \"ТранспортСервис\"', 'г. Москва, ул. Матросова, 22', '+78758778877', 'Перевозка грузов');
...
(1, 'admin', 'sSylzFbLU5Nj9Rn-SlYwA38W8ZCQ_qoR', '$2y$13$tHMCnKqqddl3THkrvELNEeiBxw5DvZkQgawtI/vGsdunGYS9nYB9u', NULL, 'admin@wis.loc', 10, 1577925150, 1577925150);
...
INSERT INTO `vendor` (`idvendor`, `name`, `adress`, `phone`, `info`) VALUES
(1, 'ООО \"ЕУСтройМат\"', 'г. Москва, ул. Строителей, 223', '+7876775677', 'Производство строительных материалов');
...
--
ALTER TABLE `acceptmaterial`
    MODIFY `idaccept` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `inventarisation`
    MODIFY `idinventarisation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `materialcategory`
    MODIFY `idmaterialcategory` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `materialstorage`
--
ALTER TABLE `materialstorage`
    MODIFY `idfoodstorage` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `storehouse`
--
ALTER TABLE `storehouse`
    MODIFY `idstorehouse` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `transporter`
--
ALTER TABLE `transporter`
    MODIFY `idtransporter` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
